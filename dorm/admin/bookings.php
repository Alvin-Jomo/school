        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Dorm Bookings</h4>
            ...
            <form method="POST">
                ...
                <?php
                    ...
                    <div class="alert alert-primary alert-dismissible bg-primary text-white border-0 fade show"
                        ...
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                ...
                                <strong>Info: </strong> You have already booked!!!
                    </div>
                    <?php }
                    else{
						echo "";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Total Fees Per Term</h4>
                                    <div class="form-group">
