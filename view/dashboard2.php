...
?>   
              <span class="info-box-number"><small>Ksh </small><?php echo $current_total_salary;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
$sql3="SELECT SUM(paid) FROM teacher_salary WHERE index_number='$'";
$total_earn=0;
$result3=mysqli_query($conn,$sql3);
$row3=mysqli_fetch_assoc($result3);
...
?>             
              ...
              <span class="info-box-number"><small>Ksh </small><?php echo $total_earn;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
