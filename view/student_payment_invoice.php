...
?>                                    
                             ...
                             <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="col-md-1">Amount(Ksh)</th>
                            ...
                            <div class="row">
                                <div class="col-xs-1 text-right pdetail1">
                                      <strong>
                                        <span id="spanmFee"><?php echo $monthly_fee; ?>Ksh</span> <br>
										<span id="spanTotal"><?php echo $paid; ?>Ksh</span> <br>
                                        <span id="spanPaid"><?php echo $paid; ?>Ksh</span> <br>
                                      </strong>
  								</div>
