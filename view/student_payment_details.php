...
?>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td id="mFee_lMonth">Ksh<?php echo $last_paid;  ?></td>
                                              
                                            </tr>
                                            <tr>
                                                <td>Paid</td>
                                                <td id="lastPaid">Ksh<?php echo $last_paid;  ?></td>
                                            </tr>
                                            <tr>
                                                <td>Current Month</td>
...
?>                                            
                                                <td id="current_mFee">Ksh<?php echo $monthly_fee ?> </td>
                                            </tr>
                                            <tr>
                                                <td>Paid</td>
<?php
...
?>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td id="dueAmount">Ksh<?php echo $due; ?> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
