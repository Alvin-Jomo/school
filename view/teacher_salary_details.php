...
?>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td id="tSalary_lMonth">Ksh<?php echo $total_salary_lmonth;  ?></td>
                                              
                                            </tr>
                                            <tr>
                                                <td>Paid</td>
                                                <td id="lastPaid">Ksh<?php echo $total_salary_lmonth;  ?></td>
                                            </tr>
                                            <tr>
                                                <td>Current Month</td>
...
?>                                            
                                                <td id="currentSalary">Ksh<?php echo $current_total_salary; ?> </td>
                                            </tr>
                                            <tr>
                                                <td>Paid</td>
<?php
...
?>                                            
                                                <td id="currentPaid"> ksh<?php echo $paid_current_month; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Due Amount </td>
                                                
                                                <td id="dueAmount">Ksh<?php echo $balance; ?> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
