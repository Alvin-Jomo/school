...
?>  
              <span class="info-box-number"><small>Ksh  </small><?php echo $monthly_fee ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
?>              
              <span class="info-box-number"><small>Ksh  <small><?php echo $total_paid; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
